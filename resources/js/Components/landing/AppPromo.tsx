...
export function AppPromo() {
    ...
    return (
        <section className="flex w-full pt-[60px] md:pt-[140px] max-w-[1440px] 1440:flex-row flex-col-reverse 1440:px-0 px-3 items-center gap-[18px]">
            <div className="flex rounded-[16px] flex-1 w-full overflow-hidden min-h-[300px] md:min-h-[400px]">
                <iframe
                    className="w-full h-full min-h-[300px] md:min-h-[400px]"
                    src="https://www.youtube.com/embed/xpz-_gDOcrI?si=NOjYyjUGG0LJoW9w"
